...
define('PRODUCTION_CERTIFICATE_KEY', '/app/ApplePay.key.pem');
define('PRODUCTION_CERTIFICATE_PATH', '/app/ApplePay.crt.pem');

// This is the password you were asked to create in terminal when you extracted ApplePay.key.pem
define('PRODUCTION_CERTIFICATE_KEY_PASS', 'Ad@g3t3c###'); 
...
define('PRODUCTION_DISPLAYNAME', 'Adage Portal Payment');
